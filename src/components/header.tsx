...
export function Header() {
  ...
  return (
    <header className="flex justify-between items-center p-4 min-w-full h-16 relative z-50 border-b-custom blur-custom  ">
      ...
      <div className="items-center text-white pl-3 md:ml-28 md:text-[1.7rem] text-[1.4rem] font-bold z-30">
        <Link to="/">
      ...
      {/* Desktop nav */}
      <nav className="nav hidden items-center md:flex text-[1rem] gap-10 text-white font-medium">
